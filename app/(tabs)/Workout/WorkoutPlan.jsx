    ...
    const renderExercise = ({ item }) => {
      ...
      if (exercise) {    
        return(  
          ...
          <TouchableOpacity onPress={() => router.push({pathname: '/Workout/ExerciseData',params: { exerciseId: `${exercise.id}`}})}>
    ...
    <View className="mt-16 text-white">
        ...
        <View className="border-borderB bg-cardB border p-4 rounded-lg">
         ...
         <Image
               ...
               resizeMode = "contain"
             />
           <Text className='text-gray-400 self-center text-sm'>made by gymleveling</Text>
